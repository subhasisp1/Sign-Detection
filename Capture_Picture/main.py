...
switch_pin = pyb.Pin('A0', pyb.Pin.IN, pull=pyb.Pin.PULL_UP)
...
def start_streaming(s):
    ...
    while True:
        ...
        if switch_pin.value():  # Switch/button not pressed
            led.off()  # Turn off the LED
        else:  # Switch/button pressed
            led.on()  # Turn on the LED
            frame.save("snapshot-%d.jpg" % random.getrandbits(32))
